          ...
          {step === 'email' ? (
            <>
              <div className="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                  <input
                    ...
                    placeholder="Student email address (.edu)"
                  />
                </div>
                <div>
                  <input
              ...
              <div className="text-sm text-gray-600">
                <p>Only students with .edu email addresses can register.</p>
              </div>
              <div>
                <button
                  type="submit"
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                ...
                >
                  ...
                  <span className="ml-2">Google (.edu required)</span>
                </button>
                <p className="mt-2 text-xs text-gray-500 text-center">
                  Google sign-in only works with .edu email addresses
                </p>
              </div>
            </div>
          )}
