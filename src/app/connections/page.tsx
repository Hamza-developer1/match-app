      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-blue-600">🤝 Your Connections</h1>
              <p className="text-gray-600 mt-1">{connections.length} connections found</p>
            </div>
          </div>
        ...
        {connections.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-8 text-center">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">No Connections Yet</h2>
            <p className="text-gray-600 mb-6">You haven't connected with anyone yet. Start discovering people!</p>
            <Link
              href="/discover"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowProfileModal(false)}>
          <div className="bg-white rounded-lg p-6 m-4 max-w-md w-full max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center mb-6">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">{selectedProfile.name}</h4>
              ...
              <div className="space-y-4">
                {selectedProfile.profile.university && (
                  <div>
                    ...
                    <p className="text-gray-600">{selectedProfile.profile.university}</p>
                  </div>
                )}
                ...
                {selectedProfile.profile.major && (
                  <div>
                    ...
                    <p className="text-gray-600">{selectedProfile.profile.major}</p>
                  </div>
                )}
                ...
                {selectedProfile.profile.bio && (
                  <div>
                    ...
                    <p className="text-gray-600">{selectedProfile.profile.bio}</p>
                  </div>
                )}
              </div>
            )}
